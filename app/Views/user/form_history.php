...
<div class="form-container my-3">
    ...
    <form id="multi-step-form" action="<?= site_url('user/save_history') ?>" method="post" enctype="multipart/form-data">
        <!-- Step 1 -->
        <div class="step active" id="step1">
            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <select id="educate" name="educate" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="file" id="imageUpload2" name="profile_pic" class="form-control" accept="image/*" onchange="previewImage2(event)" required>
            </div>
        ...
        <div class="step" id="step2">
            ...
            <div class="form-group">
                <div class="form-check">
                    ...
                    <input type="hidden" id="user_type" name="user_type" value="ทั่วไป">
                    <label class="form-check-label" for="consentCheckbox">
                        ...
                        โดยสำนักงานจัดหางานจังหวัดกระบี่ (หน่วยงานราชการ) และจะถูกลบออกจากระบบโดยอัตโนมัติภายใน 90 วัน
                    </label>
                </div>
            </div>
